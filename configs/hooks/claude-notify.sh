...
# BEL character triggers monitor-bell → window turns yellow in status bar
printf '\a'

# ── 2. Add 🔔 prefix to window name ────────────────────────────────────────
...
# OSC 777 (notification) — supported by Ghostty, iTerm2
# OSC 9 (notification) — broader compatibility
